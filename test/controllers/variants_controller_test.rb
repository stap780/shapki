...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference("Variant.count") do
      post variants_url, params: { variant: { price: @variant.price, product_id: @variant.product_id, quantity: @variant.quantity, sku: @variant.sku, uid: @variant.uid } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { price: @variant.price, product_id: @variant.product_id, quantity: @variant.quantity, sku: @variant.sku, uid: @variant.uid } }
